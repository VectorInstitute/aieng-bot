...
def _render_capabilities(
    ...
    parts += [
        ...
        "general knowledge about them: for example, BookStack has an API for",
        "creating and editing pages, but you have no tool for it, so you",
        "cannot write to BookStack.",
        "",
